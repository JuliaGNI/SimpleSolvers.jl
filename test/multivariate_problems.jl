...
obj1 = MultivariateOptimizerProblem(F, x)
obj2 = MultivariateOptimizerProblem(F, G!, x)

function f_g_calls_initialization(obj1::MultivariateOptimizerProblem, obj2::MultivariateOptimizerProblem)
...
function return_correct_value(obj1::MultivariateOptimizerProblem, obj2::MultivariateOptimizerProblem, x::AbstractVector, y::Number)
...
function return_correct_value_inplace(obj1::MultivariateOptimizerProblem, obj2::MultivariateOptimizerProblem, x::AbstractVector, y::Number)
    @test value!(obj1, x) == value!(obj2, x) == y
...
function return_correct_gradients(obj1::MultivariateOptimizerProblem, obj2::MultivariateOptimizerProblem, x::AbstractVector, z::AbstractVector)
    @test gradient(obj1, x) == gradient(obj2, x) == z
    @test f_calls(obj1) == f_calls(obj2) == 0
    @test g_calls(obj1) == g_calls(obj2) == 1
end

function return_correct_gradients_inplace(obj1::MultivariateOptimizerProblem, obj2::MultivariateOptimizerProblem, x::AbstractVector, z::AbstractVector)
@test gradient!(obj1, x) == gradient!(obj2, x) == z
@test f_calls(obj1) == f_calls(obj2) == 0
