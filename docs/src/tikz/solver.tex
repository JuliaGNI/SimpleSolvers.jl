...
\begin{tikzpicture}
  \path[mindmap,concept color=black,text=white]
    ...
    child[concept color=mblue] {node[concept] {\texttt{nonlinearsystem::\\Nonlinear-\\System}} [clockwise from=-30] child[concept color=mgreen] { node[concept] {\texttt{j::Jacobian}}}}
    ...
    child[concept color=morange!50!mpurple] {node[concept] {\texttt{status::\\Optimizer-\\Status}}};
\end{tikzpicture}
\end{document}