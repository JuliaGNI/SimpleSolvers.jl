...
An [`Optimizer`](@ref) stores an [`OptimizerState`](@ref), a [`OptimizerProblem`](@ref), the [`SimpleSolvers.OptimizerResult`](@ref) and an [`SimpleSolvers.OptimizerMethod`](@ref). Its purposes are:
