...
```@example optimizer
using SimpleSolvers: NewtonOptimizerState, NewtonOptimizerCache, OptimizerResult, initialize!, LinesearchState
...
opt₂ = Optimizer(alg, obj, hes, result, _cache, _linesearch)
```
